...
The generator needs the TypeScript 5 compiler API, which TypeScript 7 does not ship, so the script runs it through npx in a temp directory with its own TypeScript 5.
