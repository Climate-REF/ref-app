 ...
 * List Collections
 */
export const explorerListCollections = <ThrowOnError extends boolean = false>(options?: Options<ExplorerListCollectionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ExplorerListCollectionsResponse, unknown, ThrowOnError>({
 ...
 * Get Collection
 */
export const explorerGetCollection = <ThrowOnError extends boolean = false>(options: Options<ExplorerGetCollectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ExplorerGetCollectionResponse, ExplorerGetCollectionError, ThrowOnError>({
 ...
 * List Themes
 */
export const explorerListThemes = <ThrowOnError extends boolean = false>(options?: Options<ExplorerListThemesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ExplorerListThemesResponse, unknown, ThrowOnError>({
 ...
 * Get Theme
 */
export const explorerGetTheme = <ThrowOnError extends boolean = false>(options: Options<ExplorerGetThemeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ExplorerGetThemeResponse, ExplorerGetThemeError, ThrowOnError>({
