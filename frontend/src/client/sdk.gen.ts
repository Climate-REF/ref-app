...
import type { MetricsListMetricsData, MetricsListMetricsResponse, MetricsGetMetricData, MetricsGetMetricResponse, MetricsGetMetricError, ExecutionsListExecutionsData, ExecutionsListExecutionsResponse, ExecutionsListExecutionsError, ExecutionsGetExecutionData, ExecutionsGetExecutionResponse, ExecutionsGetExecutionError, ExecutionsGetExecutionResultData, ExecutionsGetExecutionResultResponse, ExecutionsGetExecutionResultError, ExecutionsGetExecutionResultDatasetsData, ExecutionsGetExecutionResultDatasetsResponse, ExecutionsGetExecutionResultDatasetsError, ResultsGetResultData, ResultsGetResultError, UtilsHealthCheckData, UtilsHealthCheckResponse } from './types.gen';
 ...
 */
export const executionsGetExecution = <ThrowOnError extends boolean = false>(options: Options<ExecutionsGetExecutionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ExecutionsGetExecutionResponse, ExecutionsGetExecutionError, ThrowOnError>({
