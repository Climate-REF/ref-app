...
import type { MetricsListMetricsData, MetricsListMetricsResponse, MetricsGetMetricData, MetricsGetMetricResponse, MetricsGetMetricError, MetricsGetMetricExecutionsData, MetricsGetMetricExecutionsResponse, MetricsGetMetricExecutionsError, MetricsGetMetricValuesData, MetricsGetMetricValuesResponse, MetricsGetMetricValuesError, ExecutionsListExecutionsData, ExecutionsListExecutionsResponse, ExecutionsListExecutionsError, ExecutionsGetExecutionGroupData, ExecutionsGetExecutionGroupResponse, ExecutionsGetExecutionGroupError, ExecutionsGetExecutionResultData, ExecutionsGetExecutionResultResponse, ExecutionsGetExecutionResultError, ExecutionsGetExecutionResultDatasetsData, ExecutionsGetExecutionResultDatasetsResponse, ExecutionsGetExecutionResultDatasetsError, ExecutionsGetExecutionResultLogsData, ExecutionsGetExecutionResultLogsError, ResultsGetResultData, ResultsGetResultError, UtilsHealthCheckData, UtilsHealthCheckResponse } from './types.gen';
 ...
 * Fetch a result using the slug
 */
export const metricsGetMetricValues = <ThrowOnError extends boolean = false>(options: Options<MetricsGetMetricValuesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<MetricsGetMetricValuesResponse, MetricsGetMetricValuesError, ThrowOnError>({
