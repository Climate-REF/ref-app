...
import { type Options, metricsListMetrics, metricsGetMetric, metricsListExecutionGroups, metricsListMetricValues, executionsList, executionsGet, executionsExecution, executionsResultDatasets, executionsResultLogs, executionsMetricBundle, executionsListMetricValues, resultsGetResult, utilsHealthCheck } from '../sdk.gen';
import { queryOptions } from '@tanstack/react-query';
import type { MetricsListMetricsData, MetricsGetMetricData, MetricsListExecutionGroupsData, MetricsListMetricValuesData, ExecutionsListData, ExecutionsGetData, ExecutionsExecutionData, ExecutionsResultDatasetsData, ExecutionsResultLogsData, ExecutionsMetricBundleData, ExecutionsListMetricValuesData, ResultsGetResultData, UtilsHealthCheckData } from '../types.gen';
...
export const metricsListExecutionGroupsQueryKey = (options: Options<MetricsListExecutionGroupsData>) => createQueryKey('metricsListExecutionGroups', options);

export const metricsListExecutionGroupsOptions = (options: Options<MetricsListExecutionGroupsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await metricsListExecutionGroups({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: metricsListExecutionGroupsQueryKey(options)
    });
};
