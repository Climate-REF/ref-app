...
import { type Options, metricsListMetrics, metricsGetMetric, metricsGetMetricExecutions, executionsListExecutions, executionsGetExecutionGroup, executionsGetExecutionResult, executionsGetExecutionResultDatasets, executionsGetExecutionResultLogs, executionsGetMetricBundle, executionsGetMetricValues, resultsGetResult, utilsHealthCheck } from '../sdk.gen';
import { queryOptions } from '@tanstack/react-query';
import type { MetricsListMetricsData, MetricsGetMetricData, MetricsGetMetricExecutionsData, ExecutionsListExecutionsData, ExecutionsGetExecutionGroupData, ExecutionsGetExecutionResultData, ExecutionsGetExecutionResultDatasetsData, ExecutionsGetExecutionResultLogsData, ExecutionsGetMetricBundleData, ExecutionsGetMetricValuesData, ResultsGetResultData, UtilsHealthCheckData } from '../types.gen';
...
export const executionsGetMetricBundleQueryKey = (options: Options<ExecutionsGetMetricBundleData>) => createQueryKey('executionsGetMetricBundle', options);

export const executionsGetMetricBundleOptions = (options: Options<ExecutionsGetMetricBundleData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await executionsGetMetricBundle({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: executionsGetMetricBundleQueryKey(options)
    });
};

export const executionsGetMetricValuesQueryKey = (options: Options<ExecutionsGetMetricValuesData>) => createQueryKey('executionsGetMetricValues', options);

export const executionsGetMetricValuesOptions = (options: Options<ExecutionsGetMetricValuesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await executionsGetMetricValues({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: executionsGetMetricValuesQueryKey(options)
    });
};
