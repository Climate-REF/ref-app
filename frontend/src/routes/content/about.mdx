...
The CMIP Rapid Evaluation Framework (Climate REF) is an automated system for evaluating Earth system models participating in the Coupled Model Intercomparison Project Phase 7 (CMIP7).
...
We track the datasets that where used to generate any values.
